...
const socialLinks = [
  { name: "facebook", href: "https://www.facebook.com/shopkitkutak" },
  { name: "instagram", href: "https://www.instagram.com/shopkit_ba" },
  { name: "tiktok", href: "https://www.tiktok.com/@shopkit_kutak" },
  { name: "linkedin", href: "https://www.linkedin.com/company/o-s-p-d-shopkit/" },
];
        ...
        <div className="w-full flex flex-col items-center justify-center px-4 md:px-8 py-6 md:py-8">
            ...
            <div className="flex flex-col items-center md:items-start">
              ...
              <div className="flex flex-col gap-3 font-poppins text-xs md:text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="opacity-90">info@shopkit.ba</p>
                </div>
              </div>
            </div>
          ...
          <div className="w-full border-t border-white/20 pt-6 pb-6">
            ...
            <div className="flex flex-wrap justify-center items-center gap-3 md:gap-4">
              ...
              >
                <Image
                  src="/shopkit_payments/mastercard.svg"
                  alt="Mastercard"
                  width={50}
                  height={32}
                  className="h-6 w-auto object-contain"
              ...
              >
                <Image
                  src="/shopkit_payments/maestro.svg"
                  alt="Maestro"
                  width={50}
                  height={32}
                  className="h-6 w-auto object-contain"
              ...
              >
                <Image
                  src="/shopkit_payments/pay-web-monri.svg"
                  alt="Monri"
                  width={60}
                  height={32}
                  className="h-6 w-auto object-contain"
              ...
              >
                <Image
                  src="/shopkit_payments/visa-secure.svg"
                  alt="Visa Secure"
                  width={50}
                  height={32}
                  className="h-6 w-auto object-contain"
              ...
              >
                <Image
                  src="/shopkit_payments/ID-check.svg"
          ...
          <div className="w-full border-t border-white/20 pt-6 text-center">
            <p className="font-poppins text-xs md:text-sm opacity-90">
              © {new Date().getFullYear()} ShopKit D.O.O. | Sva prava zadržana | Powered by ClixCode
            </p>
          </div>
        </div>
      </footer>
