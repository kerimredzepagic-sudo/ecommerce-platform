...
> = {
  premium: {
    color: "#673626",
    logo: "/shopkit_logos/SHOPKIT_Premium_light.png",
    name: "ShopKit Premium",
  },
  originals: {
    color: "#431E10",
    logo: "/shopkit_logos/SHOPKIT_Originals_no background.png",
    name: "ShopKit Originals",
  },
  health: {
    color: "#ED5926",
    logo: "/shopkit_logos/SHOPKIT_Health_no background.png",
    name: "ShopKit Health",
  },
  energy: {
    color: "#ED5926",
    logo: "/shopkit_logos/SHOPKIT_white Energy.png",
    name: "ShopKit Energy",
  },
};
...
export default function ProductPageClient() {
  ...
  const handleShare = useCallback(async () => {
    const shareData = {
      title: productData?.name || "ShopKit Proizvod",
      text:
