                  ...
                  <div className="mt-6 pt-4 border-t border-gray-100">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <a href="https://www.visa.com" target="_blank" rel="noopener noreferrer" className="bg-gray-50 rounded p-1.5 hover:shadow transition-shadow">
                        <Image src="/maksuz_payments/visa.svg" alt="Visa" width={40} height={24} className="h-5 w-auto object-contain" />
                      </a>
                      <a href="https://www.mastercard.com" target="_blank" rel="noopener noreferrer" className="bg-gray-50 rounded p-1.5 hover:shadow transition-shadow">
                        <Image src="/maksuz_payments/mastercard.svg" alt="Mastercard" width={40} height={24} className="h-5 w-auto object-contain" />
                      </a>
                      <a href="https://www.mastercard.com" target="_blank" rel="noopener noreferrer" className="bg-gray-50 rounded p-1.5 hover:shadow transition-shadow">
                        <Image src="/maksuz_payments/maestro.svg" alt="Maestro" width={40} height={24} className="h-5 w-auto object-contain" />
                      </a>
                    </div>
                    <div className="flex items-center gap-2 mt-3">
                      <a href="https://monri.com" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
                        <Image src="/maksuz_payments/pay-web-monri.svg" alt="Monri" width={60} height={20} className="h-4 w-auto object-contain" />
                      </a>
